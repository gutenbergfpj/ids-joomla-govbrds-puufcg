                ...
                <div class="header-top">
                    ...
                    <div class="header-govlinks tema-<?php echo $this->params->get('tema'); ?>-main">
                        ...
                        <ul aria-label="Páginas do site">
                            <li>
                                <a href="https://www.gov.br/mec/" class="header-sign h8 m-0 header-sign-border tema-<?php echo $this->params->get('tema'); ?>-main-header-border">Ministério da Educação</a>
                            </li>
                            <li>
